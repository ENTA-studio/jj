...
Structure.extend(
  ...
  (Player) =>
    class extends Player {
      ...
      setLofi(lofi) {
        if (typeof lofi !== "boolean") {
          throw new RangeError(
            'Player#setLofi() Lofi can only be "true" or "false".'
          );
        }
...
class MoonMusic extends Manager {
  /**
   *
   * @param {Client} client
   */
