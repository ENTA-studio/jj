...
const disabled = '<:Moon_Disable:1135195035651027035><:Moon_enable2:1135195732652064889>'
const enabled = '<:Moon_Enable:1135195129485987872><:Moon_disable2:1135195761286590506> '
  ...
  execute: async (message, args, client, prefix, channels) => {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields([
        ...
        { name: '__Boost Status__', value: `Count <:Moon_Boost:1135196616131870862> : ${server.premiumSubscriptionCount}` },
